...
class HybridEmbed(nn.Module):
    ...
    """
    def __init__(self, backbone, img_size=32, feature_size=None, in_chans=3, embed_dim=48):
        super().__init__()
...
class ConvViT(nn.Module):
    ...
    """
    def __init__(self, img_size=32, patch_size=4, in_chans=3, num_classes=100, embed_dim=48, depth=4,
